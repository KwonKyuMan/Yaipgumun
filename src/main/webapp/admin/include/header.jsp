			...
			<table width=1200 align=center id="a">
						    ...
						    <c:when test="${sessionScope.level ne null }">
						        ...
						        <c:choose>
						            ...
						            <c:when test="${sessionScope.connecttype == '카카오'}">
						                <a href="/member/logoutkakao">[로그아웃]</a>
						            </c:when>
						            <c:when test="${sessionScope.connecttype == '네이버'}">
						                <span onclick="naverLogout()" style="cursor:pointer">[로그아웃]</span>
						            </c:when>
						        </c:choose>
						    </c:when>
						</c:choose>
				...
				<tr>
					<td align="right" height="25" id="a">
						<a href="/notice/noticelist">[자유게시판]</a>
					</td>
				</tr>
				<tr>
					<td align="right" height="25" id="a">
				...
				<tr>
					<td align="right" height="25" id="a">
						<a href="/admin/orders/adminorderlist">[주문관리]</a>
						<a href="/admin/banner/bannerlist">[배너관리]</a>
