    	...
    	<tr>
    		<c:choose>
    			<c:when test="${cate1 != null && cate1 != '' }">
    				<td align=center colspan=9 id="itemall"><a href="list?category1=${cate1}" style="color:white;font-size:20px;">전체상품보기</a></td>
    			</c:when>
    			<c:otherwise>
    				<td align=center colspan=9 id="itemall"><a href="mainsearch?search=${search }" style="color:white;font-size:20px;">전체상품보기</a></td>
    			</c:otherwise>
    		</c:choose>
    	</tr>
    	<tr height="5"></tr>
